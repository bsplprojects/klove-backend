...
exports.getProfile = async (req, res) => {
  try {
    ...
    const result = await pool.request().input("UserId", sql.VarChar, userId)
      .query(`
        SELECT Name, ConsumerID, JoiningDate, Product_Name, rank, uplineid, Placement, Password, MobileNo, PhoneNo,SponsorId, SponsorName, Country, City, Address, State, PinCode,Sex
        FROM member_details
